...
int fwscanf(FILE* __restrict__ stream, const wchar_t* __restrict__ format, ...);
int swprintf(wchar_t* __restrict__ s, size_t n, const wchar_t* __restrict__ format, ...);
int swscanf(const wchar_t* __restrict__ s, const wchar_t* __restrict__ format, ...);
int vfwprintf(FILE* __restrict__ stream, const wchar_t* __restrict__ format, va_list arg);
int vfwscanf(FILE* __restrict__ stream, const wchar_t* __restrict__ format, va_list arg);
int vswprintf(wchar_t* __restrict__ s, size_t n, const wchar_t* __restrict__ format, va_list arg);
int vswscanf(const wchar_t* __restrict__ s, const wchar_t* __restrict__ format, va_list arg);
...
long int wcstol(const wchar_t* __restrict__ nptr, wchar_t** __restrict__ endptr, int base);
long long int wcstoll(const wchar_t* __restrict__ nptr, wchar_t** __restrict__ endptr, int base);
unsigned long int wcstoul(const wchar_t* __restrict__ nptr, wchar_t** __restrict__ endptr, int base);
unsigned long long int wcstoull(const wchar_t* __restrict__ nptr, wchar_t** __restrict__ endptr, int base);

// 7.29.4.2 Wide string copying functions
wchar_t* wcscpy(wchar_t* __restrict__ s1, const wchar_t* __restrict__ s2);
wchar_t* wcsncpy(wchar_t* __restrict__ s1, const wchar_t* __restrict__ s2, size_t n);
...
wchar_t* wcscat(wchar_t* __restrict__ s1, const wchar_t* __restrict__ s2);
wchar_t* wcsncat(wchar_t* __restrict__ s1, const wchar_t* __restrict__ s2, size_t n);

// 7.29.4.4 Wide string comparison functions
int wcscmp(const wchar_t* s1, const wchar_t* s2);
int wcscoll(const wchar_t* s1, const wchar_t* s2);
int wcsncmp(const wchar_t* s1, const wchar_t* s2, size_t n);
size_t wcsxfrm(wchar_t* __restrict__ s1, const wchar_t* __restrict__ s2, size_t n);
...
wchar_t* wcstok(wchar_t* __restrict__ s1, const wchar_t* __restrict__ s2, wchar_t** __restrict__ ptr);
...
size_t mbrlen(const char* __restrict__ s, size_t n, mbstate_t* __restrict__ ps);
size_t mbrtowc(wchar_t* __restrict__ pwc, const char* __restrict__ s, size_t n, mbstate_t* __restrict__ ps);
